...
class CountDown(tk.Frame): 
    ...
    def build_interface(self):
        ...
        self.clock = tk.Label(self, text="00:00:00", font=("Arial", 24), width=10)
        self.clock.grid(row=1, column=1, stick="S")

        self.time_label = tk.Label(self, text="hour   min   sec", font=("Calibri", 12), width=15)
...
if __name__ == "__main__":
    ...
    root = tk.Tk()
    root.title("TIMER")
    CountDown(root).pack(side="top", fill="both", expand=True)
    root.mainloop()